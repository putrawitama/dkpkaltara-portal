...
var validation = {
	...
	addMethods:function() {
		...
		jQuery.validator.addMethod("STD_VAL_WEB_1", function(value, element) {
			return this.optional(element) || /^(?=.*\d)([a-zA-Z0-9]+)(?!.*[#<>\/\\=”’"'!@#$%^&()])(?!.*\s).{6,10}$/.test(value);
		...
		}, "Password kombinasi huruf kapital, huruf kecil, angka, dan minimum 8 karakter");
        ...
        jQuery.validator.addMethod("STD_VAL_WEB_6_2", function(value, element) {
			return this.optional(element) || /^[a-zA-Z0-9]{5,16}$/.test(value);
		}, "Nomor KTP/Passport yang Anda masukkan salah. Max 16 karakter dengan isian huruf/angka");
