...
<div class="d-sm-flex align-items-center mb-4">
    <a href="{{ route('get.list-adsense') }}" class="text-gray-800 mr-3" style="font-size:1.5rem">
...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ route('post.store-adsense') }}" method="POST" id="formAddAdsense" enctype="multipart/form-data">
            @csrf
            <div class="row">
