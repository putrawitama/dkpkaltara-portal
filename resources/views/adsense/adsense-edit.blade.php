...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ route('post.update-external') }}" method="POST" id="formEditExternal" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-11 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="url" name="link" id="link" class="form-control bg-gray-200 border-0" placeholder="Enter URL" value="{{ $detail['link'] }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-10 col-md-12">
                            <div class="form-group" id="select2ErrorInstalasi">
                                ...
                                <div class="custom-control custom-switch">
                                    ...
                                    <label class="custom-control-label" for="customSwitch1">*Choose to publish</label>
                                </div>
                            </div>
                        </div>
                    </div>
